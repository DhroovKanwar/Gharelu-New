...
const Wordmark = ({ className }) => (
  <a href="#top" className={cn("font-heading font-extrabold tracking-tight", className)} data-testid="logo">
    ...
    >
      <nav className="mx-auto flex max-w-[1440px] items-center justify-between px-6 py-4 md:px-12 lg:px-20">
        ...
        <div className="flex items-center gap-3">
          <Button as="a" href="#featured" size="sm" className="hidden sm:inline-flex" data-testid="order-now-btn">
            Order Now
          </Button>
          <button
        ...
        {open && (
          ...
          >
            <div className="flex flex-col gap-1 px-6 py-6">
              ...
              <Button as="a" href="#featured" className="mt-3 w-full" onClick={() => setOpen(false)}>
                Order Now
              </Button>
