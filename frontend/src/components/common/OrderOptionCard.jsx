...
export const OrderOptionCard = ({
  ...
  <motion.div
    ...
    whileHover={{ y: -8 }}
    className={cn(
      "group flex h-full flex-col rounded-[2rem] p-5 shadow-[0_18px_50px_-24px_rgba(215,134,159,0.45)] transition-shadow duration-500 hover:shadow-[0_30px_70px_-24px_rgba(215,134,159,0.6)] sm:p-6 md:p-7",
      variant === "soft"
  ...
  >
    <div className="flex items-center justify-between">
      <motion.span
        ...
        className={cn(
          "grid h-12 w-12 place-items-center rounded-full transition-colors duration-500 group-hover:bg-brand-accent group-hover:text-white sm:h-14 sm:w-14",
    ...
    <h3 className="mt-4 font-heading text-2xl font-extrabold tracking-tight text-brand-dark md:text-3xl">{title}</h3>
    <p className="mt-2 flex-1 text-base leading-relaxed text-brand-text">{description}</p>
